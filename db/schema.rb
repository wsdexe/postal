...
ActiveRecord::Schema[7.0].define(version: 2026_07_17_010000) do
  ...
  create_table "servers", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    ...
    t.string "received_header", default: "from api (10-42-11-130.email.vs-ru.svc.cluster.local [10.42.11.130]) by VS with HTTP", null: false
